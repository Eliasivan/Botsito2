    ...
    try {
      ...
      if (!name) {
        ...
        return socket.sendMessage(msg.messages[0]?.key.remoteJid, {
          text: "Ingresa el nombre de la canción, Ejemplo: !play Hello Cotto 🐫.",
        });
      }
      ...
      if (!video) {
        ...
        await socket.sendMessage(msg.messages[0]?.key.remoteJid, {
          text: "Sin resultados, intente ser más especifico.",
        });
      ...
      if (video.seconds > 1200) {
        ...
        await socket.sendMessage(msg.messages[0]?.key.remoteJid, {
          text: "El vídeo no debe superar los 20 minutos, pruebe con otra canción.",
        });
      ...
      await socket.sendMessage(msg.messages[0]?.key.remoteJid, {
        text: "Sucedió un error inesperado, intente nuevamente.",
      });
